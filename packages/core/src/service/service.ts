...
export class Service implements IService {
  ...
  // public async writeTmpFile(opts: {
  //   path: string;
  //   content?: string;
  //   tpl?: string;
  ...
  //     isJsFile && '// This file is generated by Dite automatically',
  ...
  //   if (this.appData.vite && isJsFile) {
  //     content = transformIEAR({ content, path: absPath }, this);
  //   }
  //
  //   if (opts.format) {
  //     const tsconfig = join(this.cwd, './server/tsconfig.json');
