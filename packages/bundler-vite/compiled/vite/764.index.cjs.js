...
/* harmony export */   "Watcher": function() { return /* binding */ Watcher; }
/* harmony export */ });
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1017);
/* harmony import */ var process__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7282);
/* harmony import */ var _rollup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2975);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2037);
...
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2781);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2361);
/* harmony import */ var perf_hooks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4074);
/* harmony import */ var crypto__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6113);
/*
  @license
	Rollup.js v2.77.2
...
function mergeOptions(config, rawCommandOptions = { external: [], globals: undefined }, defaultOnWarnHandler = _rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .defaultOnWarn */ .Z6) {
    ...
    const outputOptionsArray = (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .ensureArray */ .rY)(config.output);
    ...
    (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .warnUnknownOptions */ .G3)(command, Object.keys(inputOptions).concat(Object.keys(outputOptions[0]).filter(option => option !== 'sourcemapPathTransform'), Object.keys(commandAliases), 'config', 'environment', 'plugin', 'silent', 'failAfterWarnings', 'stdin', 'waitForBundleInput', 'configPlugin'), 'CLI flags', warn, /^_$|output$|config/);
...
function mergeInputOptions(config, overrides, defaultOnWarnHandler) {
    ...
    const inputOptions = {
        ...
        perf: getOption('perf'),
        plugins: (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .ensureArray */ .rY)(config.plugins),
        preserveEntrySignatures: getOption('preserveEntrySignatures'),
        preserveModules: getOption('preserveModules'),
        preserveSymlinks: getOption('preserveSymlinks'),
        shimMissingExports: getOption('shimMissingExports'),
        strictDeprecations: getOption('strictDeprecations'),
        treeshake: getObjectOption(config, overrides, 'treeshake', (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .objectifyOptionWithPresets */ .Sz)(_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .treeshakePresets */ .SL, 'treeshake', 'false, true, ')),
        watch: getWatch(config, overrides)
    };
    (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .warnUnknownOptions */ .G3)(config, Object.keys(inputOptions), 'input options', inputOptions.onwarn, /^output$/);
    return inputOptions;
}
const getExternal = (config, overrides) => {
    ...
    return typeof configExternal === 'function'
        ...
        : (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .ensureArray */ .rY)(configExternal).concat(overrides.external);
};
const getOnWarn = (config, defaultOnWarnHandler) => config.onwarn
    ? warning => config.onwarn(warning, defaultOnWarnHandler)
    : defaultOnWarnHandler;
const getObjectOption = (config, overrides, name, objectifyValue = _rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .objectifyOption */ .oz) => {
...
function mergeOutputOptions(config, overrides, warn) {
    ...
    const outputOptions = {
        ...
        generatedCode: getObjectOption(config, overrides, 'generatedCode', (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .objectifyOptionWithPresets */ .Sz)(_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .generatedCodePresets */ .xn, 'output.generatedCode', '')),
    ...
    (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .warnUnknownOptions */ .G3)(config, Object.keys(outputOptions), 'output options', warn);
    return outputOptions;
}

var chokidar = {};

const fs$3 = fs__WEBPACK_IMPORTED_MODULE_4__;
const { Readable } = stream__WEBPACK_IMPORTED_MODULE_6__;
const sysPath$3 = path__WEBPACK_IMPORTED_MODULE_0__;
const { promisify: promisify$3 } = util__WEBPACK_IMPORTED_MODULE_5__;
const picomatch$1 = _rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .picomatch.exports */ .ZS.exports;
...
const picomatch = _rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .picomatch.exports */ .ZS.exports;
...
var pathPosixDirname = path__WEBPACK_IMPORTED_MODULE_0__.posix.dirname;
var isWin32 = os__WEBPACK_IMPORTED_MODULE_3__.platform() === 'win32';
...
const util = util__WEBPACK_IMPORTED_MODULE_5__;
...
(function (exports) {
	...
	const {sep} = path__WEBPACK_IMPORTED_MODULE_0__;
	const {platform} = process;
	const os = os__WEBPACK_IMPORTED_MODULE_3__;
...
const fs$2 = fs__WEBPACK_IMPORTED_MODULE_4__;
const sysPath$2 = path__WEBPACK_IMPORTED_MODULE_0__;
const { promisify: promisify$2 } = util__WEBPACK_IMPORTED_MODULE_5__;
...
const require$$3 = /*@__PURE__*/(0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .getAugmentedNamespace */ .RL)(_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .fseventsImporter */ .Yw);

const fs$1 = fs__WEBPACK_IMPORTED_MODULE_4__;
const sysPath$1 = path__WEBPACK_IMPORTED_MODULE_0__;
const { promisify: promisify$1 } = util__WEBPACK_IMPORTED_MODULE_5__;
...
const { EventEmitter } = events__WEBPACK_IMPORTED_MODULE_7__;
const fs = fs__WEBPACK_IMPORTED_MODULE_4__;
const sysPath = path__WEBPACK_IMPORTED_MODULE_0__;
const { promisify } = util__WEBPACK_IMPORTED_MODULE_5__;
...
class FileWatcher {
    ...
    createWatcher(transformWatcherId) {
        ...
        const isLinux = (0,os__WEBPACK_IMPORTED_MODULE_3__.platform)() === 'linux';
...
class Watcher {
    constructor(configs, emitter) {
        ...
        process__WEBPACK_IMPORTED_MODULE_1__.nextTick(() => this.run());
    }
    async close() {
...
class Task {
    constructor(watcher, config) {
        ...
        this.outputFiles = this.outputs.map(output => {
            if (output.file || output.dir)
                return (0,path__WEBPACK_IMPORTED_MODULE_0__.resolve)(output.file || output.dir);
            return undefined;
        });
        const watchOptions = this.options.watch || {};
        this.filter = (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .createFilter */ .cj)(watchOptions.include, watchOptions.exclude);
    ...
    async run() {
        ...
        let result = null;
        try {
            result = await (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__/* .rollupInternal */ .iX)(options, this.watcher.emitter);
            if (this.closed) {
                return;
            }
